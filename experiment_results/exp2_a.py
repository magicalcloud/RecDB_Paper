...
for ax, model in zip(axes, models):
    ...
    subset_melted = subset.melt(
        ...
        var_name="DB",
        value_name="Read Latency Normalization"
    )
    ...
    ax.set_xlabel("")
    ax.set_ylabel("Read Latency Normalization" if model == models[0] else "")
    ax.legend_.remove()
