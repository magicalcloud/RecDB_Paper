...
for ax, model in zip(axes, models):
    ...
    subset_melted = subset.melt(
        ...
        var_name="DB",
        value_name="Update Latency Normalization"
    )
    ...
    sns.barplot(
        data=subset_melted,
        x="batch_size",
        y="Update Latency Normalization",
        hue="DB",
        palette=colors,
        ax=ax,
        edgecolor="black",
    ...
    ax.set_xlabel("")
    ax.set_ylabel("Update Latency Normalization" if model == models[0] else "")
    ax.legend_.remove()
